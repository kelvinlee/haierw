...
postajax = function(data) {
  return $.ajax({
    ...
    success: function(msg) {
      ...
      return _gaq.push(['_trackEvent', '移动端', '上传作品', "成功"]);
    },
    error: function(msg) {
      $("#uploadsuccess").attr('src', 'img/icon-success.png');
      $("#uploadsuccesstext").html("上传失败了<br/>试试再玩一次！");
      return _gaq.push(['_trackEvent', '移动端', '上传作品', "失败"]);
    }
  });
};
...
postajaxPC = function(data) {
  ...
  return $.ajax({
    ...
    success: function(msg) {
      ...
      _shareimgurl = msg.src;
      BindShare("有些话不愿大声说出来，不妨就写在充满雾气的浴室玻璃上吧！那些话，隐秘而伟大。", "http://site.douban.com/haier_waterheater/", _shareimgurl);
      return _gaq.push(['_trackEvent', '扫描二维码', '上传作品', "成功"]);
    },
    error: function(msg) {
      $("#uploadsuccess").attr('src', 'img/icon-success.png');
      $("#uploadsuccesstext").html("上传失败了<br/>试试再玩一次！");
      return _gaq.push(['_trackEvent', '扫描二维码', '上传作品', "失败"]);
    }
  });
};
...
showFirstFrame = function() {
  ...
  starBG = true;
  bindDecade();
  return _gaq.push(['_trackEvent', '移动端', '游戏', '选择年代']);
};
...
createRSQlist = function() {
  ...
  for (i = _i = 1; _i <= 15; i = ++_i) {
    ...
    item.click(function() {
      ...
      return _gaq.push(['_trackEvent', '移动端', '选择热水器', $("p", this).text()]);
    });
  }
...
GameOver = function() {
  ...
  return $("[data-weixin]").click(function() {
    $(".weixinshare").show();
    return _gaq.push(['_trackEvent', '移动端', '分享', "weixin"]);
  });
};
...
BindShare = function(content, url, pic) {
  ...
  return $("[data-share]").unbind('click').bind('click', function() {
    ...
    return _gaq.push(['_trackEvent', '移动端', '分享', $(this).data('share')]);
  });
};
...
ReadyStarGame = function() {
  RSQRfadeO = true;
  startGame();
  return _gaq.push(['_trackEvent', '移动端', '游戏', '开始']);
};
